...
A function is (usually) defined by:
...
As a toy dataset, we will use the data published by *Horvath et al.* [^2] and available on GEO ([GSE52194](https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE52194)).  
...
The previous VolcanoPlot is not very nice, and writting you own function can be useful to make beautiful paper !
...
d.ensembl <- read.csv("/shared/projects/dubii2020/data/rnaseq/countsdata/tablecounts_raw_ensembl.csv", row.names = 1)
