...
* 1 échantillon TNBC (TNBC) : SRR1027171 (GSM1261016)
* 1 échantillon NonTNBC (NonTNBC) : SRR1027177 (GSM1261022)
...
Nous allons croiser ces données hétérogènes pour répondre à différentes questions :
...
Il faut dans un premier temps récupérer les coordonnées du gène.
...
## Combien de variants connus existe-t-il dans ce gène ?

<div class="alert danger">Attention, le format de sortie correspond au format du fichier passé par l'option -a ! </div>
